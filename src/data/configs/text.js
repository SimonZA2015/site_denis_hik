...
export let headerHomeText = {
    ...
    span1: "Тренер-наездник лошадей",
}
let listTitleProjectSlider = ['Horse Book', 'Проекты', 'VRChat'];
let listSpanProjectSlider = ['Нацеленно на обьеденение услуг для лошадей в одном приложении', 'Список проектов', 'Список проектов для VR Chat'];
