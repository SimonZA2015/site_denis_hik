...
let listTitleProjectSlider = ['Horse Book', 'Узнать больше'];
let listSpanProjectSlider = ['Нацеленно на обьеденение услуг для лошадей в одном приложении', 'Список проектов'];
