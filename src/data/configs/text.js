...
let listTitleProjectSlider = ['Horse Book', 'Projects', 'VRChat'];
let listSpanProjectSlider = ['Focus on one application for all your Horse Management', 'List of Projects', 'List of Projects for VR Chat'];
